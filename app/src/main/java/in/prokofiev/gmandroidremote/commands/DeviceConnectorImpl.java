...
import in.prokofiev.gmandroidremote.BluetoothUtils;
...
public class DeviceConnectorImpl implements DeviceConnector {
    ...
    public DeviceConnectorImpl(String btAddress, Handler handler) {
        mHandler = handler;
        btAdapter = BluetoothAdapter.getDefaultAdapter();
        connectedDevice = btAdapter.getRemoteDevice(btAddress);
        mState = STATE_NONE;
    }
    // ==========================================================================
    ...
    private synchronized void setState(int state) {
        ...
        mState = state;
        mHandler.obtainMessage(state, -1).sendToTarget();
    }
    // ==========================================================================
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            synchronized (DeviceConnectorImpl.this) {
                mConnectThread = null;
            }
